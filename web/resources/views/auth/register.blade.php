<x-layouts.guest>
    <h2 class="text-xl font-semibold text-brand-text text-center mb-6">Create your account</h2>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        {{-- Full Name --}}
        <div>
            <label for="name" class="block text-sm font-medium text-brand-text-secondary mb-1">Full Name</label>
        ...
        <button type="button" disabled
                class="w-full py-2.5 bg-transparent border border-brand-border text-brand-text-secondary text-sm font-medium rounded-lg hover:border-brand-cyan/50 hover:text-brand-text transition-colors cursor-not-allowed opacity-60">
    ...
    <p class="mt-6 text-center text-sm text-brand-text-secondary">
        ...
        <a href="{{ route('login') }}" class="text-brand-cyan hover:text-brand-purple font-medium transition-colors">Login</a>
    </p>
</x-layouts.guest>
