<div>
    ...
    <div class="mb-6 sm:mb-8">
        <h1 class="text-xl sm:text-2xl font-semibold text-[#ededed]">Connections</h1>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-[#252525] rounded-lg border border-[#333333] overflow-hidden">
            <div class="px-4 sm:px-6 py-4 sm:py-5 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div class="flex items-center gap-3 sm:gap-4">
                    <div class="w-10 h-10 rounded-lg bg-[#202020] border border-[#333333] flex items-center justify-center shrink-0">
