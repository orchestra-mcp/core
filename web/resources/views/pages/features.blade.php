...
<head>
    ...
    <x-seo
        title="Features - Orchestra MCP"
        description="55 MCP tools, AI agent teams, real-time collaboration, and full self-hosting. Everything you need to run your company with AI."
    />
...
<body class="min-h-screen bg-[--color-bg-default] text-[--color-text-secondary]">
    {{-- Navigation --}}
    <x-public-header activePage="features" />
    ...
    <main class="relative overflow-hidden">
        ...
        {{-- Feature sections --}}
        <div class="relative max-w-6xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 space-y-14 sm:space-y-20">
            ...
            <section>
                <div class="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[--color-brand-text-secondary] max-w-2xl">A comprehensive toolkit spanning 11 categories, all accessible through the Model Context Protocol. Every tool is designed to work seamlessly with Claude Code.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    @foreach ($categories as [$name, $desc, $icon])
                        <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-5 hover:bg-[--color-bg-surface-300] transition-colors">
                            ...
                            <p class="text-xs text-[--color-brand-text-secondary] leading-relaxed">{{ $desc }}</p>
                        </div>
                    @endforeach
                </div>
            </section>
            ...
            <section>
                <div class="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[--color-brand-text-secondary] max-w-2xl">40+ specialized AI agents covering every discipline. Each agent has persistent memory, semantic search, and decision logging -- they remember context across sessions.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Every agent maintains long-term memory across sessions. Context is never lost -- agents pick up exactly where they left off.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Vector-powered search finds relevant context automatically. Agents retrieve the right information at the right time.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-purple/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Every architectural decision is recorded with rationale, alternatives considered, and outcomes -- building an institutional knowledge base.</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[--color-brand-text-secondary] max-w-2xl">Real-time collaboration across your entire team. Activity feeds, session tracking, and shared context keep everyone aligned.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">See what your team is working on in real time. Changes propagate instantly across all connected sessions.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-purple/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Full audit trail of every action across your organization. Filter by team, project, agent, or time range.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-cyan/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Track active sessions across all team members. Resume any session from any device with full context preservation.</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[--color-brand-text-secondary] max-w-2xl">Deep GitHub integration for repository management, automated PR creation, and CLAUDE.md generation -- bridging AI agents with your codebase.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Connect and manage multiple repositories. Agents understand your codebase structure and conventions automatically.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-cyan/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">AI agents create pull requests with proper descriptions, linked issues, and review assignments -- all automated.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-purple/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Auto-generate and maintain CLAUDE.md files that give AI agents deep understanding of your project structure and conventions.</p>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-[--color-brand-text-secondary] max-w-2xl">Full control over your data and infrastructure. Deploy on your own servers with Docker, manage with Supabase Studio, and never worry about vendor lock-in.</p>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Your data stays on your servers. Complete ownership with no third-party access to your codebase or agent memory.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-purple/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Manage your database, users, and storage with the full Supabase Studio admin panel. No command-line required.</p>
                    </div>
                    <div class="bg-[--color-bg-surface] border border-[--color-border] rounded-xl p-6 hover:bg-[--color-bg-surface-300] transition-colors">
                        <div class="w-10 h-10 rounded-lg bg-brand-cyan/10 flex items-center justify-center mb-4">
                        ...
                        <p class="text-sm text-[--color-brand-text-secondary] leading-relaxed">Open standards, open protocol. Export your data anytime. Switch providers or self-host without losing anything.</p>
                    </div>
                </div>
            </section>
        </div>
        ...
        <div class="relative max-w-3xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24 text-center">
            ...
            <p class="text-[--color-brand-text-secondary] mb-8">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
                ...
                <a href="{{ route('docs') }}" wire:navigate class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3.5 border border-[--color-border] text-white font-semibold rounded-lg hover:bg-[--color-bg-surface-300] transition-colors text-base sm:text-lg">
                    Read the Docs
                </a>
            </div>
        </div>
